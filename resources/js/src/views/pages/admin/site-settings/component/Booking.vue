<template>
  <div class="vx-col w-full md:w-12/12 mb-base">
    <vx-card class="mb-5 ml-2 mr-5 mt-5">
      <div class="vx-row">
        <div class="vx-col sm:w-1/3 lg:w-1/1 mb-2">
          <vs-input
            :label="$t('price')"
            placeholder="ex= 120"
            v-model="calendarInfo.price"
            class="mt-5 w-full"
          />
        </div>
        ...
        <div class="vx-col sm:w-1/3 lg:w-1/1 mb-2">
          <vs-input
            :label="$t('timeout_price')"
            placeholder="ex= 18"
            v-model="calendarInfo.timeout_price"
            class="mt-5 w-full"
          />
        </div>
      </div>
    ...
    <div class="flex flex-wrap items-center justify-end">
      <vs-button class="ml-auto mt-2" @click="SaveData('calendarInfo')">{{
        $t("save")
      }}</vs-button>
    </div>
  </div>
