  ...
  <head>
    ...
    <style type="text/css" media="screen">
      ...
      .gradient {
        ...
        background: linear-gradient(to right, #b1c4e6, #6dd5fa, #2980b9);
      }
                                              ...
                                              >
                                                ...
                                                >
                                                  <tr>
                                                    ...
                                                    >
                                                      <strong
                                                        >Ihre Reservierung wurde erstellt</strong
                                                      >
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                ...
                                                @endphp
                                                        ...
                                                        <div> {!! QrCode::size(200)->generate($data['payment']->payment_id); !!}</div>
                                                        <img src="{!!$message->embedData(QrCode::format('png')->generate($data['payment']->payment_id), 'QrCode.png', 'image/png')!!}">
                                                        <br>
                                                aaa
                              ...
                              >
                                ...
                                <tr>
                                  <td
                                    ...
                                    "
                                  >
                                    Adresse: 1234 Some St Deutschland,
									CA 94102, US 1.800.123.4567
                                    <br />
                                    <a
                                      href="tel:02125322018"
                                      target="_blank"
                                      class="link c-white"
                                      style="
                                        text-decoration: none;
                                    ...
                                    <br />
                                    <a
                                      href="mailto:info@aquaquell.com"
                                      target="_blank"
                                      class="link c-white"
                                      style="
                                        text-decoration: none;
