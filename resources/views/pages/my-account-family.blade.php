                            ...
                            <div class="column sc_col-sm-3 accountSidebar">
                                <div class="accountOptions">
                                    ...
                                    <ul>
                                        ...
                                        <li class="active"><a href="/my-account-family">Weitere Personen</a></li>
                            ...
                            @isset($partners)
                                ...
                                @foreach($partners  as $key=> $partner)
                                        ...
                                        <div class="kontoInformation">
                                            ...
                                            <form action="{{route('calendar.partnerUpdate')}}" id="familyForm" method="post">
                                                @csrf
                                                <div class="input">
                                                ...
                                                <div class="input">
                                                    ...
                                                    <input type="date" id="Geburtsdatum" name="Geburtsdatum"
                                                           ...
                                                           @isset($partnerData['birth_date']) value="{{$partnerData['birth_date']}}" @endisset
                                                    >
                                                </div>
                                                <div class="input">
                                                    <label for="Geburtsdatum">Anrede</label>
                                                    <select name="anrede" >
{{--                                                        <option >@isset($partnerData['anrede']) {{$partnerData['anrede']}} @endisset</option>--}}
                                                        <option value="Herr">Herr</option>
                                                        <option value="Frau">Frau</option>
                                                    </select>
                                                </div>
                                                <div style="text-align: center; flex-basis: 100%;">
                                                    <a onclick="document.getElementById('familyForm').submit()"
