...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login() {
      ...
      this.$store.dispatch('auth/login', payload).then(function (response) {
        ...
        _this.showAlert(_i18n_i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t('Error'), _i18n_i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t('your_credentials_not_match_our_records'), 'icon-alert-circle', 'warning');
      });
    },
