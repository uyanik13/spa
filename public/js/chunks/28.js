...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteData: function deleteData(index) {
      ...
      this.$store.dispatch('post/removeProductGalleryImage', obj).then(function (response) {
        console.log(response.data);
        _this2.fileList = response.data.gallery;
                                ...
                                [
                                  ...
                                  _c("span", [
                                    _vm._v(
                                      _vm._s(
                                        _vm.$t(
                                          "You_can_upload_your_gallery_to_here"
                                        )
                                      )
                                    )
                                  ]),
                                  ...
                                  _vm._l(_vm.fileList, function(file, index) {
                                    return _c(
                                      "div",
                                      {
                                        key: index,
                                        staticClass:
                                          "vx-col w-full sm:w-1/5 lg:w-1/5 mb-base"
                                      },
                                      [
                                        _c("vx-card", [
                                          _c(
